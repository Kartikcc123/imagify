      ...
      <div>
        {user ? (
          <div onClick={()=>navigate("/buy")} className="flex items-center gap-2 sm:gap-3">
            ...
            <p className="text-gray-700 max-sm:hidden pl-4">Hi , GreatStack</p>
          ...
          <div className="flex items-center gap-2 sm:gap-5">
            ...
            <button onClick ={()=>setShowLogin(true)} className="bg-zinc-800 text-white px-7 py-2 sm:px-8 text-sm rounded-full ">
              Login
            </button>
          </div>
        )}
